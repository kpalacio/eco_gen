...
#####ERROR RUNNING LINE 95: "Error in plotCounts(dds, gene = "TRINITY_DN46709_c0_g1_TRINITY_DN46709_c0_g1_i1_g.23138_m.23138",  : 
...
#plotPCA(rld, intgroup=c("status","date")) ### ERROR:Error in plotPCA(rld, intgroup = c("status", "date")) : 
...
dev.off() #should I get something here? I didnt get anything
...
nt <- normTransform(dds) # defaults to log2(x+1) ###ERROR : could not find function "normTransform. i COULDNT RUN THE NEXT 3 LINES
